/**
 * Block-status read — GET /api/blocks/:userId/status. The write half
 * (POST/DELETE) still goes client -> Supabase directly, not yet routed
 * through the gateway.
 */
...
/** Whether the caller has blocked the given user. */
