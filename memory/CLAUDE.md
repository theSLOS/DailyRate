...
| 5.5   | Front server + Redis caching layer                                     | in progress (Concepts 1–2 complete; Concept 3 built, content tests pending) |
...
Concept 3 (`GET /api/feed`, uncached) are built; the rest below are standing
